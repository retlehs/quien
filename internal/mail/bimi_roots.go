...
// Known BIMI Verified Mark Certificate (VMC) root CAs.
// These are not part of the system trust store because they only issue
// logotype/BIMI certificates, so we bundle them explicitly and verify
// fetched VMCs against this pool.
const bimiRootsPEM = `-----BEGIN CERTIFICATE-----
